...
const f="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",E={
begin:"\\\\[\\s\\S]",relevance:0},y={scope:"string",begin:"'",end:"'",
illegal:"\\n",contains:[E]},N={scope:"string",begin:'"',end:'"',illegal:"\\n",
contains:[E]},w=(e,n,t={})=>{const a=s({scope:"comment",begin:e,end:n,
...
},v=w("//","$"),O=w("/\\*","\\*/"),M=w("#","$");var x=Object.freeze({
__proto__:null,MATCH_NOTHING_RE:/\b\B/,IDENT_RE:"[a-zA-Z]\\w*",
UNDERSCORE_IDENT_RE:"[a-zA-Z_]\\w*",NUMBER_RE:"\\b\\d+(\\.\\d+)?",C_NUMBER_RE:f,
BINARY_NUMBER_RE:"\\b(0b[01]+)",
RE_STARTERS_RE:"!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",
SHEBANG:(e={})=>{const n=/^#![ ]*\//
;return e.binary&&(e.begin=b(n,/.*\b/,e.binary,/\b.*/)),s({scope:"meta",begin:n,
end:/$/,relevance:0,"on:begin":(e,n)=>{0!==e.index&&n.ignoreMatch()}},e)},
BACKSLASH_ESCAPE:E,APOS_STRING_MODE:y,QUOTE_STRING_MODE:N,PHRASAL_WORDS_MODE:{
begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/
},COMMENT:w,C_LINE_COMMENT_MODE:v,C_BLOCK_COMMENT_MODE:O,HASH_COMMENT_MODE:M,
NUMBER_MODE:{scope:"number",begin:"\\b\\d+(\\.\\d+)?",relevance:0},
C_NUMBER_MODE:{scope:"number",begin:f,relevance:0},BINARY_NUMBER_MODE:{
...
void 0!==e.className&&(e.scope=e.className,delete e.className)}function k(e,n){
...
Array.isArray(e.illegal)&&(e.illegal=m(...e.illegal))}function T(e,n){
if(e.match){
if(e.begin||e.end)throw Error("begin & end are not supported with match")
;e.begin=e.match,delete e.match}}function R(e,n){
...
;function L(e,n,t="keyword"){const a=Object.create(null)
;return"string"==typeof e?i(t,e.split(" ")):Array.isArray(e)?i(t,e):Object.keys(e).forEach((t=>{
Object.assign(a,L(e[t],n,t))})),a;function i(e,t){
n&&(t=t.map((e=>e.toLowerCase()))),t.forEach((n=>{const t=n.split("|")
;a[t[0]]=[e,B(t[0],t[1])]}))}}function B(e,n){
return n?Number(n):(e=>I.includes(e.toLowerCase()))(e)?0:1}const $={},z=e=>{
console.error(e)},F=(e,...n)=>{console.log("WARN: "+e,...n)},U=(e,n)=>{
$[`${e}/${n}`]||(console.log(`Deprecated as of ${e}. ${n}`),$[`${e}/${n}`]=!0)
},j=Error();function P(e,n,{key:t}){let a=0;const i=e[t],s={},r={}
;for(let e=1;e<=n.length;e++)r[e+a]=i[e],s[e+a]=!0,a+=p(n[e-1])
;e[t]=r,e[t]._emit=s,e[t]._multi=!0}function K(e){(e=>{
...
j;P(e,e.begin,{key:"beginScope"}),e.begin=h(e.begin,{joinWith:""})}})(e),(e=>{
...
j;P(e,e.end,{key:"endScope"}),e.end=h(e.end,{joinWith:""})}})(e)}function q(e){
...
;[A,T,K,D].forEach((e=>e(i,r))),e.compilerExtensions.forEach((e=>e(i,r))),
i.__beforeBegin=null,[k,C,R].forEach((e=>e(i,r))),i.isCompiled=!0;let l=null
;return"object"==typeof i.keywords&&i.keywords.$pattern&&(i.keywords=Object.assign({},i.keywords),
l=i.keywords.$pattern,
delete i.keywords.$pattern),l=l||/\w+/,i.keywords&&(i.keywords=L(i.keywords,e.case_insensitive)),
...
variants:null},n)))),e.cachedVariants?e.cachedVariants:H(e)?s(e,{
...
}),e.illegal&&n.addRule(e.illegal,{type:"illegal"}),n})(o),o}(e)}function H(e){
return!!e&&(e.endsWithParent||H(e.starts))}const Z=i,G=s,W=Symbol("nomatch")
;var Q=(e=>{const n=Object.create(null),i=Object.create(null),s=[];let r=!0
...
;"object"==typeof n?(a=e,
t=n.ignoreIllegals,i=n.language):(U("10.7.0","highlight(lang, code, ...args) has been deprecated."),
...
const n=e[0],a=t.substr(e.index),i=_(M,e,a);if(!i)return W;const s=M
...
let y={};function N(n,s){const o=s&&s[0];if(A+=n,null==o)return g(),0
...
;throw e.mode=M,e}if("end"===s.type){const e=E(s);if(e!==W)return e}
...
;const v=q(w);let O="",M=s||v;const x={},S=new d.__emitter(d);(()=>{const e=[]
...
language:e,value:Z(t),illegal:!1,relevance:0,errorRaised:n,_emitter:S,_top:M}
;throw n}}function m(e,t){t=t||d.languages||Object.keys(n);const a=(e=>{
const n={value:Z(e),illegal:!1,relevance:0,_top:l,_emitter:new d.__emitter(d)}
...
U("10.7.0","Please use highlightElement now."),p(e)),configure:e=>{d=G(d,e)},
initHighlighting:()=>{
h(),U("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")},
initHighlightingOnLoad:()=>{
h(),U("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")
...
autoDetection:y,inherit:G,addPlugin:e=>{(e=>{
...
;for(const e in x)"object"==typeof x[e]&&t(x[e]);return Object.assign(e,x),e
})({});const X=e=>({IMPORTANT:{scope:"meta",begin:"!important"},HEXCOLOR:{
...
_:[...de,...ge]}},y={variants:[{match:[/function/,/\s+/,n,/(?=\s*\()/]},{
match:[/function/,/\s*(?=\()/]}],className:{1:"keyword",3:"title.function"},
label:"func.def",contains:[h],illegal:/%/},N={
match:b(/\b/,(w=[...ue,"super"],b("(?!",w.join("|"),")")),n,g(/\(/)),
...
const _e=e=>b(/\b/,e,/\w$/.test(e)?/\b/:/\B/),he=["Protocol","Type"].map(_e),fe=["init","self"].map(_e),Ee=["Any","Self"],ye=["actor","associatedtype","async","await",/as\?/,/as!/,"as","break","case","catch","class","continue","convenience","default","defer","deinit","didSet","do","dynamic","else","enum","extension","fallthrough",/fileprivate\(set\)/,"fileprivate","final","for","func","get","guard","if","import","indirect","infix",/init\?/,/init!/,"inout",/internal\(set\)/,"internal","in","is","isolated","nonisolated","lazy","let","mutating","nonmutating",/open\(set\)/,"open","operator","optional","override","postfix","precedencegroup","prefix",/private\(set\)/,"private","protocol",/public\(set\)/,"public","repeat","required","rethrows","return","set","some","static","struct","subscript","super","switch","throws","throw",/try\?/,/try!/,"try","typealias",/unowned\(safe\)/,/unowned\(unsafe\)/,"unowned","var","weak","where","while","willSet"],Ne=["false","nil","true"],we=["assignment","associativity","higherThan","left","lowerThan","none","right"],ve=["#colorLiteral","#column","#dsohandle","#else","#elseif","#endif","#error","#file","#fileID","#fileLiteral","#filePath","#function","#if","#imageLiteral","#keyPath","#line","#selector","#sourceLocation","#warn_unqualified_access","#warning"],Oe=["abs","all","any","assert","assertionFailure","debugPrint","dump","fatalError","getVaList","isKnownUniquelyReferenced","max","min","numericCast","pointwiseMax","pointwiseMin","precondition","preconditionFailure","print","readLine","repeatElement","sequence","stride","swap","swift_unboxFromSwiftValueWithType","transcode","type","unsafeBitCast","unsafeDowncast","withExtendedLifetime","withUnsafeMutablePointer","withUnsafePointer","withVaList","withoutActuallyEscaping","zip"],Me=m(/[/=\-+!*%<>&|^~?]/,/[\u00A1-\u00A7]/,/[\u00A9\u00AB]/,/[\u00AC\u00AE]/,/[\u00B0\u00B1]/,/[\u00B6\u00BB\u00BF\u00D7\u00F7]/,/[\u2016-\u2017]/,/[\u2020-\u2027]/,/[\u2030-\u203E]/,/[\u2041-\u2053]/,/[\u2055-\u205E]/,/[\u2190-\u23FF]/,/[\u2500-\u2775]/,/[\u2794-\u2BFF]/,/[\u2E00-\u2E7F]/,/[\u3001-\u3003]/,/[\u3008-\u3020]/,/[\u3030]/),xe=m(Me,/[\u0300-\u036F]/,/[\u1DC0-\u1DFF]/,/[\u20D0-\u20FF]/,/[\uFE00-\uFE0F]/,/[\uFE20-\uFE2F]/),Se=b(Me,xe,"*"),Ae=m(/[a-zA-Z_]/,/[\u00A8\u00AA\u00AD\u00AF\u00B2-\u00B5\u00B7-\u00BA]/,/[\u00BC-\u00BE\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF]/,/[\u0100-\u02FF\u0370-\u167F\u1681-\u180D\u180F-\u1DBF]/,/[\u1E00-\u1FFF]/,/[\u200B-\u200D\u202A-\u202E\u203F-\u2040\u2054\u2060-\u206F]/,/[\u2070-\u20CF\u2100-\u218F\u2460-\u24FF\u2776-\u2793]/,/[\u2C00-\u2DFF\u2E80-\u2FFF]/,/[\u3004-\u3007\u3021-\u302F\u3031-\u303F\u3040-\uD7FF]/,/[\uF900-\uFD3D\uFD40-\uFDCF\uFDF0-\uFE1F\uFE30-\uFE44]/,/[\uFE47-\uFEFE\uFF00-\uFFFD]/),ke=m(Ae,/\d/,/[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/),Ce=b(Ae,ke,"*"),Te=b(/[A-Z]/,ke,"*"),Re=["autoclosure",b(/convention\(/,m("swift","block","c"),/\)/),"discardableResult","dynamicCallable","dynamicMemberLookup","escaping","frozen","GKInspectable","IBAction","IBDesignable","IBInspectable","IBOutlet","IBSegueAction","inlinable","main","nonobjc","NSApplicationMain","NSCopying","NSManaged",b(/objc\(/,Ce,/\)/),"objc","objcMembers","propertyWrapper","requires_stored_property_inits","resultBuilder","testable","UIApplicationMain","unknown","usableFromInline"],De=["iOS","iOSApplicationExtension","macOS","macOSApplicationExtension","macCatalyst","macCatalystApplicationExtension","watchOS","watchOSApplicationExtension","tvOS","tvOSApplicationExtension","swift"]
;var Ie=Object.freeze({__proto__:null,grmr_bash:e=>{const n={},t={begin:/\$\{/,
...
const n=X(e),t=[e.APOS_STRING_MODE,e.QUOTE_STRING_MODE];return{name:"CSS",
...
begin:":("+Y.join("|")+")"},{begin:"::("+ee.join("|")+")"}]},n.CSS_VARIABLE,{
className:"attribute",begin:"\\b("+ne.join("|")+")\\b"},{begin:":",end:"[;}]",
...
$pattern:/[a-z-]+/,keyword:"and or not only",attribute:J.join(" ")},contains:[{
begin:/[a-z-]+(?=:)/,className:"attribute"},...t,n.CSS_NUMBER_MODE]}]},{
className:"selector-tag",begin:"\\b("+V.join("|")+")\\b"}]}},grmr_diff:e=>({
...
const n="[\xc0-\u02b8a-zA-Z_$][\xc0-\u02b8a-zA-Z_$0-9]*",t=n+re("(?:<"+n+"~~~(?:\\s*,\\s*"+n+"~~~)*>)?",/~~~/g,2),a={
...
contains:[i,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,se,e.C_BLOCK_COMMENT_MODE]
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},se,i]}},grmr_javascript:pe,
...
},l=se,c=e.COMMENT("/\\*","\\*/",{contains:[e.C_BLOCK_COMMENT_MODE]}),d={
...
const n=X(e),t=te,a="([\\w-]+|@\\{[\\w-]+\\})",i=[],s=[],r=e=>({
className:"string",begin:"~?"+e+".*?"+e}),o=(e,n,t)=>({className:e,begin:n,
relevance:t}),l={$pattern:/[a-z-]+/,keyword:"and or not only",
attribute:J.join(" ")},c={begin:"\\(",end:"\\)",contains:s,keywords:l,
relevance:0}
...
begin:"\\b("+ne.join("|")+")\\b",end:/(?=:)/,starts:{endsWithParent:!0,
...
begin:"\\b("+V.join("|")+")\\b",className:"selector-tag"
},o("selector-tag",a+"%?",0),o("selector-id","#"+a),o("selector-class","\\."+a,0),o("selector-tag","&",0),n.ATTRIBUTE_SELECTOR_MODE,{
className:"selector-pseudo",begin:":("+Y.join("|")+")"},{
className:"selector-pseudo",begin:"::("+ee.join("|")+")"},{begin:/\(/,end:/\)/,
...
relevance:0},s,c,e.HASH_COMMENT_MODE,{match:[/def/,/\s+/,"[a-zA-Z_]\\w*"],
scope:{1:"keyword",3:"title.function"},contains:[d]},{variants:[{
match:[/class/,/\s+/,"[a-zA-Z_]\\w*",/\s*/,/\(\s*/,"[a-zA-Z_]\\w*",/\s*\)/]},{
match:[/class/,/\s+/,"[a-zA-Z_]\\w*"]}],scope:{1:"keyword",3:"title.class",
6:"title.class.inherited"}},{className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,
contains:[l,d,s]}]}},grmr_python_repl:e=>({aliases:["pycon"],contains:[{
...
grmr_scss:e=>{const n=X(e),t=ee,a=Y,i="@[a-z-]+",s={className:"variable",
begin:"(\\$[a-zA-Z-][a-zA-Z0-9_-]*)\\b"};return{name:"SCSS",case_insensitive:!0,
illegal:"[=/|']",contains:[e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE,{
className:"selector-id",begin:"#[A-Za-z0-9_-]+",relevance:0},{
className:"selector-class",begin:"\\.[A-Za-z0-9_-]+",relevance:0
},n.ATTRIBUTE_SELECTOR_MODE,{className:"selector-tag",
begin:"\\b("+V.join("|")+")\\b",relevance:0},{className:"selector-pseudo",
begin:":("+a.join("|")+")"},{className:"selector-pseudo",
begin:"::("+t.join("|")+")"},s,{begin:/\(/,end:/\)/,contains:[n.CSS_NUMBER_MODE]
},n.CSS_VARIABLE,{className:"attribute",begin:"\\b("+ne.join("|")+")\\b"},{
...
keyword:"and or not only",attribute:J.join(" ")},contains:[{begin:i,
...
contains:["self"]}),a=[e.C_LINE_COMMENT_MODE,t],i={match:[/\./,m(...he,...fe)],
className:{2:"keyword"}},s={match:b(/\./,m(...ye)),relevance:0
},r=ye.filter((e=>"string"==typeof e)).concat(["_|0"]),o={variants:[{
className:"keyword",
match:m(...ye.filter((e=>"string"!=typeof e)).concat(Ee).map(_e),...fe)}]},l={
$pattern:m(/\b\w+/,/#\w+/),keyword:r.concat(ve),literal:Ne},c=[i,s,o],d=[{
match:b(/\./,m(...Oe)),relevance:0},{className:"built_in",
match:b(/\b/,m(...Oe),/(?=\()/)}],u={match:/->/,relevance:0},p=[u,{
className:"operator",relevance:0,variants:[{match:Se},{match:`\\.(\\.|${xe})+`}]
...
match:b(/`/,Ce,/`/)},M=[O,{className:"variable",match:/\$\d+/},{
className:"variable",match:`\\$${ke}+`}],x=[{match:/(@|#)available/,
className:"keyword",starts:{contains:[{begin:/\(/,end:/\)/,keywords:De,
contains:[...p,h,v]}]}},{className:"keyword",match:b(/@/,m(...Re))},{
className:"meta",match:b(/@/,Ce)}],S={match:g(/\b[A-Z]/),relevance:0,contains:[{
className:"type",
match:b(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/,ke,"+")
},{className:"type",match:Te,relevance:0},{match:/[?!]+/,relevance:0},{
match:/\.\.\./,relevance:0},{match:b(/\s+&\s+/,g(Te)),relevance:0}]},A={
begin:/</,end:/>/,keywords:l,contains:[...a,...c,...x,u,S]};S.contains.push(A)
;const k={begin:/\(/,end:/\)/,relevance:0,keywords:l,contains:["self",{
match:b(Ce,/\s*:/),keywords:"_|0",relevance:0
},...a,...c,...d,...p,h,v,...M,...x,S]},C={begin:/</,end:/>/,contains:[...a,S]
},T={begin:/\(/,end:/\)/,keywords:l,contains:[{
begin:m(g(b(Ce,/\s*:/)),g(b(Ce,/\s+/,Ce,/\s*:/))),end:/:/,relevance:0,
contains:[{className:"keyword",match:/\b_\b/},{className:"params",match:Ce}]
},...a,...c,...p,h,v,...x,S,k],endsParent:!0,illegal:/["']/},R={
match:[/func/,/\s+/,m(O.match,Ce,Se)],className:{1:"keyword",3:"title.function"
},contains:[C,T,n],illegal:[/\[/,/%/]},D={
match:[/\b(?:subscript|init[?!]?)/,/\s*(?=[<(])/],className:{1:"keyword"},
contains:[C,T,n],illegal:/\[|%/},I={match:[/operator/,/\s+/,Se],className:{
1:"keyword",3:"title"}},L={begin:[/precedencegroup/,/\s+/,Te],className:{
1:"keyword",3:"title"},contains:[S],keywords:[...we,...Ne],end:/}/}
...
},...c,...d,...p,h,v,...M,...x,S,k]}},grmr_typescript:e=>{const n={$pattern:oe,
keyword:le.concat(["type","namespace","typedef","interface","public","private","protected","implements","declare","abstract","readonly"]),
literal:ce,
built_in:me.concat(["any","void","number","boolean","string","object","never","enum"]),
"variable.language":be},t={className:"meta",begin:"@[A-Za-z$_][0-9A-Za-z$_]*"
...
aliases:["yml"],contains:l}}});const Le=Q;for(const e of Object.keys(Ie)){
const n=e.replace("grmr_","").replace("_","-");Le.registerLanguage(n,Ie[e])}
export default Le;