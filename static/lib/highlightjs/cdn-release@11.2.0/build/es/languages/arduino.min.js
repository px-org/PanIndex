...
},a=(r=>{const n=r.COMMENT("//","$",{contains:[{begin:/\\\n/}]
}),a="[a-zA-Z_]\\w*::",i="(?!struct)(decltype\\(auto\\)|"+e(a)+"[a-zA-Z_]\\w*"+e("<[^<>]+>")+")",s={
...
className:"title",begin:e(a)+r.IDENT_RE,relevance:0
},u=e(a)+r.IDENT_RE+"\\s*\\(",p={
...
relevance:0},h={className:"function",begin:"("+i+"[\\*&\\s]+)+"+u,
...
className:{1:"keyword",3:"title.class"}}])}})(r),i=a.keywords
;return i.type=[...i.type,...n.type],
i.literal=[...i.literal,...n.literal],i.built_in=[...i.built_in,...n.built_in],
i._hints=n._hints,a.name="Arduino",a.aliases=["ino"],a.supersetOf="cpp",a}})()
