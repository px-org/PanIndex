var hljsGrammar=(()=>{"use strict";function e(e){return t("(?:",e,")?")}
...
t("(?=",m,")")))};var m;const f=[p,l,s,a,n.C_BLOCK_COMMENT_MODE,o,c],g={
variants:[{begin:/=/,end:/;/},{begin:/\(/,end:/\)/},{
beginKeywords:"new throw return else",end:/;/}],keywords:_,contains:f.concat([{
begin:/\(/,end:/\)/,keywords:_,contains:f.concat(["self"]),relevance:0}]),
relevance:0},b={className:"function",begin:"("+i+"[\\*&\\s]+)+"+d,
returnBegin:!0,end:/[{;=]/,excludeEnd:!0,keywords:_,illegal:/[^\w\s\*&:<>.]/,
contains:[{begin:"decltype\\(auto\\)",keywords:_,relevance:0},{begin:d,
...
begin:/\(/,end:/\)/,keywords:_,relevance:0,
contains:[a,n.C_BLOCK_COMMENT_MODE,c,o,s,{begin:/\(/,end:/\)/,keywords:_,
...
contains:[].concat(g,b,p,f,[l,{
begin:"\\b(deque|list|queue|priority_queue|pair|stack|vector|map|set|bitset|multiset|multimap|unordered_map|unordered_set|unordered_multiset|unordered_multimap|array|tuple|optional|variant|function)\\s*<",
end:">",keywords:_,contains:["self",s]},{begin:n.IDENT_RE+"::",keywords:_},{
