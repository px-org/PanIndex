...
begin:/\(/,end:/\)/},u={className:"attr",begin:c,relevance:0,starts:{begin:/=/,
end:/=/,starts:{
contains:[t.NUMBER_MODE,t.QUOTE_STRING_MODE,t.APOS_STRING_MODE,m,d]}}},g={
contains:[t.NUMBER_MODE,t.QUOTE_STRING_MODE,t.APOS_STRING_MODE,{begin:/as\s+\|/,
keywords:{keyword:"as"},end:/\|/,contains:[{begin:/\w+/}]},u,m,d],returnEnd:!0
},b=t.inherit(o,{className:"name",keywords:a,starts:t.inherit(g,{end:/\)/})})
;var p;d.contains=[b];const h=t.inherit(o,{keywords:a,className:"name",
starts:t.inherit(g,{end:/\}\}/})}),N=t.inherit(o,{keywords:a,className:"name"
}),w=t.inherit(o,{className:"name",keywords:a,starts:t.inherit(g,{end:/\}\}/})})
