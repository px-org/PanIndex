...
return n.map((n=>e(n))).join("")}return a=>{const s={className:"number",
relevance:0,variants:[{begin:/([+-]+)?[\d]+_[\d_]+/},{begin:a.NUMBER_RE}]
},t=a.COMMENT();t.variants=[{begin:/;/,end:/$/},{begin:/#/,end:/$/}];const i={
...
},{begin:"'",end:"'"}]},l={begin:/\[/,end:/\]/,contains:[t,r,i,c,s,"self"],
...
starts:{end:/$/,contains:[t,l,r,i,c,s]}}]}}})();export default hljsGrammar;