...
contains:[c],starts:{relevance:0,contains:e,starts:n}}),m=(e,n)=>({
begin:"\\\\"+e+"(?![a-zA-Z@:_])",keywords:{$pattern:/\\[a-zA-Z]+/,keyword:"\\"+e
},relevance:0,contains:[c],starts:n}),g=(e,a)=>n.inherit({
begin:"\\\\begin(?=[ \t]*(\\r?\\n[ \t]*)?\\{"+e+"\\})",keywords:{
...
contains:[...["verb","lstinline"].map((e=>m(e,{contains:[b()]}))),m("mint",d(l,{
contains:[b()]})),m("mintinline",d(l,{contains:[v(),b()]})),m("url",{
contains:[v("link"),v("link")]}),m("hyperref",{contains:[v("link")]
}),m("href",d(o,{contains:[v("link")]
})),...[].concat(...["","\\*"].map((e=>[g("verbatim"+e,p("verbatim"+e)),g("filecontents"+e,d(l,p("filecontents"+e))),...["","B","L"].map((n=>g(n+"Verbatim"+e,d(o,p(n+"Verbatim"+e)))))]))),g("minted",d(o,d(l,p("minted")))),...t]
