var hljsGrammar=(()=>{"use strict";function e(e){return n("(?=",e,")")}
function n(...e){return e.map((e=>{
...
keywords:s},d={className:"string",contains:[a.BACKSLASH_ESCAPE,t],variants:[{
...
contains:[a.BACKSLASH_ESCAPE,t]})]}]},l="[0-9](_?[0-9])*",g={className:"number",
...
begin:":(?!\\s)",contains:[d,{begin:i}],relevance:0},g,{className:"variable",
begin:"(\\$\\W)|((\\$|@@?)(\\w+))(?=[^@$?])(?![A-Za-z])(?![@$?'])"},{
