...
_:[...t,...s]}},x={variants:[{match:[/function/,/\s+/,d,/(?=\s*\()/]},{
match:[/function/,/\s*(?=\()/]}],className:{1:"keyword",3:"title.function"},
label:"func.def",contains:[S],illegal:/%/},I={
...
begin:g.begin,end:g.end,skip:!0,contains:["self"]}]}]},x,{
...
name:"TypeScript",aliases:["ts","tsx"]}),m}})();export default hljsGrammar;